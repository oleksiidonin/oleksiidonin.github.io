...
(lib.t2 = function(mode,startPosition,loop) {
	...
	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t2, new cjs.Rectangle(-99.8,-27.5,199.6,55.1), null);
...
(lib.t1 = function(mode,startPosition,loop) {
	...
	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t1, new cjs.Rectangle(-136.5,-46.4,273.1,92.9), null);
...
(lib.banner = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(0,-249,1.009,1.009);
	...
	this.instance_3.setTransform(0,126);
