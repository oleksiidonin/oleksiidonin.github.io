...
p.nominalBounds = new cjs.Rectangle(0,0,160,254);
...
p.nominalBounds = new cjs.Rectangle(0,0,66,102);
...
}).prototype = getMCSymbolPrototype(lib.img3_1, new cjs.Rectangle(-33,-51,66,102), null);
...
(lib.img1_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-80,-127);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.img1_1, new cjs.Rectangle(-80,-127,160,254), null);
...
(lib.banner = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(-0.4,200.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(179).to({regX:-0.1,regY:0.1,scaleX:0.96,scaleY:0.96,x:-0.5,y:200.8},2).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-0.4,y:200.7},2).wait(2).to({regX:-0.1,regY:0.1,scaleX:0.96,scaleY:0.96,x:-0.5,y:200.8},2).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-0.4,y:200.7},2).wait(26));

	// t1
	this.instance_3 = new lib.t1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-0.3,129.3);
	...
	this.instance_4.setTransform(-208.6,-148.4,1,1,-42,0,0,-0.2,-0.5);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(154).to({_off:false},0).to({regX:0,regY:0,rotation:0,x:-84,y:-129},10,cjs.Ease.cubicOut).wait(40).to({x:194},10,cjs.Ease.cubicIn).wait(1));

	// img
	this.instance_5 = new lib.img4_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-207.5,-140.1,1,1,-43,0,0,-0.1,-0.5);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(149).to({_off:false},0).to({regY:-0.3,rotation:-13,x:-79.1,y:-97.3},10,cjs.Ease.cubicOut).wait(45).to({x:198.9},10,cjs.Ease.cubicIn).wait(1));

	// img
	this.instance_6 = new lib.img3_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-183,-161);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(144).to({_off:false},0).to({x:-19},10,cjs.Ease.cubicOut).wait(50).to({x:259},10,cjs.Ease.cubicIn).wait(1));

	// img
	this.instance_7 = new lib.img2_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-222.8,-54,1,1,9,0,0,0.2,-0.1);
	...
	this.instance_8.setTransform(-228.5,-21.1,0.89,0.89,0,0,0,-0.2,-0.1);
