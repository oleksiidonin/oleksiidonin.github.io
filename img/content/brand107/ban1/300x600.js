...
(lib.t2_3 = function(mode,startPosition,loop) {
	...
	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t2_3, new cjs.Rectangle(-89.4,-11,178.8,22.1), null);
...
(lib.t2_2 = function(mode,startPosition,loop) {
	...
	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t2_2, new cjs.Rectangle(-116.6,-11,233.3,22.1), null);
...
(lib.banner = function(mode,startPosition,loop) {
	...
	this.instance_5.setTransform(-294.5,135.8);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(115).to({_off:false},0).to({x:-28.5},15,cjs.Ease.cubicOut).wait(65).to({x:-296.5},15,cjs.Ease.cubicIn).to({_off:true},1).wait(25));

	// t2_2
	this.instance_6 = new lib.t2_2();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-268.5,106.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(105).to({_off:false},0).to({x:-2.5},15,cjs.Ease.cubicOut).wait(75).to({x:-270.5},15,cjs.Ease.cubicIn).to({_off:true},1).wait(25));

	// t2_1
	this.instance_7 = new lib.t2_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-311.3,67.7);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90).to({_off:false},0).to({x:-45.3},15,cjs.Ease.cubicOut).wait(90).to({x:-313.3},15,cjs.Ease.cubicIn).to({_off:true},1).wait(25));
