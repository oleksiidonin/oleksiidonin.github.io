...
(lib.t2_2 = function(mode,startPosition,loop) {
	...
	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t2_2, new cjs.Rectangle(-120.5,-11,241,22.1), null);
...
(lib.t2_1 = function(mode,startPosition,loop) {
	...
	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t2_1, new cjs.Rectangle(-77,-11,154,22.1), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#019ED0","#21C9FE"],[0,1],169.6,293.8,-169.5,-293.7).s().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
...
(lib.banner = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-334.9,-112.4);
	this.instance_2._off = true;
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(-273.7,-158.1);
	this.instance_3._off = true;
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(-317.2,-187.8);
	...
	this.instance_5.setTransform(-233.2,-224.2);
	...
	this.instance_6.setTransform(-332.5,-241);
...
p.nominalBounds = new cjs.Rectangle(-395,-300,795.9,600);
...
p.nominalBounds = new cjs.Rectangle(-95,300,795.9,600);
// library properties:
lib.properties = {
