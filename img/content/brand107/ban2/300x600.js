...
(lib.t2_3 = function(mode,startPosition,loop) {
	...
	// Слой_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-39.8,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t2_3, new cjs.Rectangle(-90.5,-11,101.5,22.1), null);
...
(lib.t2_2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-16.3,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t2_2, new cjs.Rectangle(-115.9,-11,199.3,22.1), null);
...
(lib.banner = function(mode,startPosition,loop) {
	...
	this.instance_5.setTransform(-261.5,135.8);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(115).to({_off:false},0).to({x:-28.5},15,cjs.Ease.cubicOut).wait(65).to({x:-263.5},15,cjs.Ease.cubicIn).to({_off:true},1).wait(25));

	// t2_2
	this.instance_6 = new lib.t2_2();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-235.5,106.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(105).to({_off:false},0).to({x:-2.5},15,cjs.Ease.cubicOut).wait(75).to({x:-237.5},15,cjs.Ease.cubicIn).to({_off:true},1).wait(25));

	// t2_1
	this.instance_7 = new lib.t2_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-278.3,67.7);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90).to({_off:false},0).to({x:-45.3},15,cjs.Ease.cubicOut).wait(90).to({x:-280.3},15,cjs.Ease.cubicIn).to({_off:true},1).wait(25));
