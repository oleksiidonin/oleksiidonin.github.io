...
p.nominalBounds = new cjs.Rectangle(0,0,126,184);


(lib.img2 = function() {
	this.initialize(img.img2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,174,232);
...
(lib.logo = function(mode,startPosition,loop) {
	...
	// Слой_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(0.2,0,1,1,0,0,0,0.2,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.logo, new cjs.Rectangle(-84.8,-12.8,169.6,25.7), null);
...
(lib.img3_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-76,-101);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.img3_1, new cjs.Rectangle(-76,-101,152,202), null);
...
(lib.img2_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-87,-116);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.img2_1, new cjs.Rectangle(-87,-116,174,232), null);
...
(lib.img1_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-63,-92);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.img1_1, new cjs.Rectangle(-63,-92,126,184), null);
...
(lib.box2_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-88,-78);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.box2_1, new cjs.Rectangle(-88,-78,176,156), null);
...
}).prototype = getMCSymbolPrototype(lib.box1_1, new cjs.Rectangle(-89,-75,178,150), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// Слой_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#071834","#103373"],[0.008,1],0,299,0,-298.9).s().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
...
(lib.banner = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,-252.6,1,1,0,0,0,0,0.1);
	...
	this.instance_4.setTransform(-198.1,-147.4,1,1,-42,0,0,-0.2,-0.5);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(154).to({_off:false},0).to({regX:0,regY:0,rotation:0,x:-73.5,y:-128},10,cjs.Ease.cubicOut).wait(40).to({x:204.5},10,cjs.Ease.cubicIn).wait(1));

	// img
	this.instance_5 = new lib.img4_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-197,-139.1,1,1,-43,0,0,-0.1,-0.5);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(149).to({_off:false},0).to({regY:-0.3,rotation:-13,x:-68.6,y:-96.3},10,cjs.Ease.cubicOut).wait(45).to({x:209.4},10,cjs.Ease.cubicIn).wait(1));

	// img
	this.instance_6 = new lib.img1_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-189.6,-161,0.554,0.554,0,0,0,-0.1,-0.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(144).to({_off:false},0).to({regX:-0.2,x:-23.7},10,cjs.Ease.cubicOut).wait(50).to({regX:0,x:259.4},10,cjs.Ease.cubicIn).wait(1));

	// img
	this.instance_7 = new lib.img3_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-227.4,-33.5,1,1,0,0,0,0.1,-0.1);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(134).to({_off:false},0).to({regX:0.2,x:54.7,y:-33.6},10,cjs.Ease.cubicOut).wait(60).to({regX:0.1,x:339.2,y:-33.5},10,cjs.Ease.cubicIn).wait(1));

	// img
	this.instance_8 = new lib.box2_1();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-228.5,-32.1,0.94,0.94,11,0,0,-0.4,-0.1);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(139).to({_off:false},0).to({regX:-0.5,regY:-0.4,x:-48.4,y:-32.4},10,cjs.Ease.cubicOut).wait(55).to({regX:-0.4,regY:-0.1,x:-48.3,y:-32.1},0).to({regX:-0.2,x:230.8},10,cjs.Ease.cubicIn).wait(1));

	// img
	this.instance_9 = new lib.img2_1();
	this.instance_9.parent = this;
	this.instance_9.setTransform(240,-79);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(89).to({_off:false},0).to({x:20},10,cjs.Ease.cubicOut).to({x:-20},25).to({x:-239},10,cjs.Ease.cubicIn).to({_off:true},1).wait(80));
...
p.nominalBounds = new cjs.Rectangle(-327,-300,661,600);
...
p.nominalBounds = new cjs.Rectangle(-27,299,661,602);
// library properties:
lib.properties = {
